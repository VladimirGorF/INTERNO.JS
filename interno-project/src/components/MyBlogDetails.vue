        ...
        <div class="articles">
          <div class="left">
            <article class="article" v-if="Tag === 'kitchen' || Tag === ''">
              ...
              <img
                class="articleImage"
                src="../assets/images/blogDetailsImages/kitchen.svg"
                alt="articleImage"
              />
              ...
              <p class="text">
                ...
                <br /><br />Embarrassing hidden in the middle of text. All the
            ...
            <article class="article" v-if="Tag === 'kitchen' || Tag === ''">
              ...
              <img
                src="../assets/images/blogDetailsImages/kitchen2.svg"
                alt="articleImage"
                class="articleImage"
              />
              <p class="text">
